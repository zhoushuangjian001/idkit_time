...
class IDKitTime {
  ...
  static String formatDateStamp(String stamp,
    ...
    try {
      ...
      return IDKitTime.formatDate(date);
    } catch (err) {
  ...
  static String formatDate(DateTime time,
    ...
    if (time != null) {
      ...
      if (connector != null && format != null) {
        handleStr = IDKitTime()._handleTime(time, connector, format);
      } else if (connector != null) {
        handleStr =
            IDKitTime()._handleTime(time, connector, TimeFormat.yyyyMMddHHmmss);
      } else if (format != null) {
        handleStr =
            IDKitTime()._handleTime(time, TimeConnector.horizontalLine, format);
      } else {
        handleStr = IDKitTime()._handleTime(
